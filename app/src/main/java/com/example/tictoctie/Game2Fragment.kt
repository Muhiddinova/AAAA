...
import com.idrok.dars2.Game2ViewModel
import kotlinx.android.synthetic.main.activity_main.*
import kotlinx.android.synthetic.main.content_main.*

class Game2Fragment : Fragment() , View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        viewModel= ViewModelProviders.of(requireActivity()).get(Game2ViewModel::class.java)
        ...
        binding.apply {
            this@Game2Fragment.viewModel.getPlayer1().observe(viewLifecycleOwner) { player1 ->
                this.tvPlayer1.text = "PlayerX: $player1"
            }
            this@Game2Fragment.viewModel.getPlayer2().observe(viewLifecycleOwner, { player2 ->
    ...
    private fun getHeight(context: Game2Fragment): Int {
        return context.resources.displayMetrics.heightPixels
    }

    private fun getWidth(context: Game2Fragment): Int {
