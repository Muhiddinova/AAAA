...
import com.idrok.dars2.Game1ViewModel
import kotlinx.android.synthetic.main.activity_main.*
import kotlinx.android.synthetic.main.content_main.*

class Game1Fragment : Fragment() , View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        // getHeight()
        viewModel= ViewModelProviders.of(requireActivity()).get(Game1ViewModel::class.java)
        ...
        binding.apply {
            this@Game1Fragment.viewModel.getPlayer1().observe(viewLifecycleOwner, { player1 ->
                this.tvPlayer1.text = "PlayerX: $player1"
            })
            this@Game1Fragment.viewModel.getPlayer2().observe(viewLifecycleOwner, { player2 ->
    ...
    private fun getHeight(context: Game1Fragment): Int {
        return context.resources.displayMetrics.heightPixels
    }

    private fun getWidth(context: Game1Fragment): Int {
